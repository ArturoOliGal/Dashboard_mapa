...
st.markdown("""
     <footer style ="text-align: center">
         <a href="#top">
             <ratio button style="position: fixed; bottom: 10px; center: 10px; background-color: transparent; border: whtie; color: white; padding: 20px 10px; text-align: center; text-decoration: none; font-size: 16px; border-radius: 5px;">
